...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js" integrity="sha384-BBtl+eGJRgqQAUMxJ7pMwbEyER4l1g+O15P+16Ep7Q9Q+zqX6gSbd85u4mG4QzX+" crossorigin="anonymous"></script>
    ...
    <body class="bg-body-tertiary">
        ...
        <div class="container p-5 my-5 bg-white border rounded-3">
            <h4>Naujo studento profilio kūrimas</h4>
            <form action="<?=BASE_URL . '/core/admin.php'?>" class="form-signin w-100 m-auto" method="post">
                <div class="mt-4 my-3">
                    <input type="text" class="form-control" name="studentUsername" id="studentUsername" placeholder="vardas.pavarde" required>
                </div>
                <div class="mb-3">
                    <label for="studentGroup" class="form-label">Grupė</label>
                    <select class="form-select" name="studentGroup">
